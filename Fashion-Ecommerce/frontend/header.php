            ...
            <nav class="navbar navbar-expand-lg custom_nav-container ">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav">
                    ...
                    <li><input type="submit" class="btn btn-danger" value="Logout" name="btn">
                    </form>';
                           if (isset($_SESSION['file'])) {
                              echo '<li class="nav-item">
                                <img src="Images/' . $_SESSION['file'] . '" alt="Profile Image" style="width: 40px; height: 40px; border-radius: 50%;">
                            </li>';
                           }
